...
def balanced(m):
    ...
    if is_weight(m):
        ...
        total_weight_left = total_weight(end(left(m)))
        total_weight_right = total_weight(end(right(m)))
        torque_left = total_weight_left * length(left(m))
        torque_right = total_weight_right * length(right(m))
...
def make_withdraw(balance, password):
    ...
    def withdraw(amount, used_password):
        nonlocal password
        nonlocal balance
        ...
        if used_password == password:
            ...
            wrong_passwords.append(used_password)
...
def make_joint(withdraw, old_password, new_password):
    ...
    if type(test) == str: 
        return test # this means wrong password
